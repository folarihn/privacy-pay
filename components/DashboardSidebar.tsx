...
export function DashboardSidebar() {
  ...
  return (
    <aside className="hidden md:flex w-[220px] shrink-0 flex-col h-full bg-black border-r border-white/[0.06]">
      {/* Logo */}
      <div className="flex items-center gap-2.5 px-5 h-[65px] border-b border-white/[0.06] shrink-0">
        <Infinity className="w-6 h-6 text-white stroke-[2.5]" />
        <span
      ...
      <div className="px-3 pt-6 flex-1">
        <p className="text-[10px] font-semibold text-white/20 uppercase tracking-widest mb-2 px-2">
          Main
        </p>
